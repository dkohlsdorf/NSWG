...
fn main() {
    ...
    let (train, max_labels, dim) = ucr_ts::UCRInstance::from_file(String::from("experiments/UCR_TS_Archive_2015/ShapesAll/ShapesAll_TRAIN"));
    let (test, _,_)              = ucr_ts::UCRInstance::from_file(String::from("experiments/UCR_TS_Archive_2015/ShapesAll/ShapesAll_TEST"));
